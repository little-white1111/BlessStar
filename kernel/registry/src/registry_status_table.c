...
const BsStatusCodeEntry k_registry_status_table[] = {
    {0, "OK", 0},          {1, "INVALID_PATH", 0},   {2, "NOT_FOUND", 0},  {3, "ALREADY_EXISTS", 0},
    {4, "FROZEN", 0},      {5, "MANIFEST", 0},       {6, "LOGICAL_ID", 0}, {7, "HUB_OVERRIDE", 0},
    {8, "INVALID_ARG", 0}, {9, "NO_DECLARATION", 0}, {10, "PHASE", 0},
};
