...
| **Sanitizer 真相源** | **Linux GitHub Actions** `tsan` job · `ctest -L kernel_pool` · ✅ [run #27057130553](https://github.com/little-white1111/BlessStar/actions/runs/27057130553) |
...
| 验证结果 | Windows `ctest -L regression` **82/82**；Linux **tsan** `kernel_pool` **3/3** ✅ [Actions #27057130553](https://github.com/little-white1111/BlessStar/actions/runs/27057130553/job/79863447667) |
