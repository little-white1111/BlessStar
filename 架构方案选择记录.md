...
| **Sanitizer 真相源** | **Linux GitHub Actions** `ci.yml` → job **`tsan (Linux Clang day20)`**；标签 **`day20\|kernel_pool`** |
...
| IMPL-21-CI-01 | **T-POOL.18** · Linux tsan kernel_pool | 第21天 | ci | 🟡 | `ci.yml` tsan job · **Linux Actions 为准** | PR 绿跑后填 run URL | 第21天 § **T-POOL-4** |
