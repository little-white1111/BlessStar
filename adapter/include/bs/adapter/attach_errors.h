 ...
 * Error semantics: BS_ATTACH_CONC_ERR_* attach-domain codes (XX-CONC-7); persist conflict uses RES-IX-12.
 * Platform notes: Distinct from BS_ATTACH_ERR_CONFLICT on persist boundary.
 */
