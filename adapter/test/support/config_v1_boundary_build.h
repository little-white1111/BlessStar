                                            ...
                                            size_t metadata_keys_per_instr)
{
    ...
    out += R"({"kernel_version":"0.4.0","adapter_version":"0.4.0","manual_requirements":[],"instructions":[)";
...
{
    std::string out;
    out += R"({"kernel_version":"0.4.0","adapter_version":"0.4.0","manual_requirements":[],"instructions":[{"type":"test","name":"long-val","metadata":{)";
    out += "\"payload\":";
