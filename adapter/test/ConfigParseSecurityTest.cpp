...
static void assert_parse_fail_schema_or_parse(const char* json, size_t min_line)
{
    ...
    BsStatus            st = bs_adapter_parser_parse_bytes(reinterpret_cast<const uint8_t*>(json),
...
static void test_depth_at_limit_ok_and_over_fail()
{
    ...
    BsStatus ok_st = bs_adapter_parser_parse_bytes(reinterpret_cast<const uint8_t*>(ok_json.data()),
