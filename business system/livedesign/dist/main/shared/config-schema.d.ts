 ...
 */
export declare function getDefaultValue(field: ConfigField): ConfigValue;
/**
 * 校验配置值是否在 contract 约束范围内
 */
export declare function validateConfigValue(field: ConfigField, value: ConfigValue): string | null;
